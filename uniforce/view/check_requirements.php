<?php
    ...
    // uncomment this to know why the site falls without any reasons
...
//        $debug['curl'] = function_exists('curl_exec');
//        if ($error_trace) {
//            printf($last_error_template, $error_trace, var_export($debug,1));
//        }
//    });
