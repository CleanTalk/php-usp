...
function usp_settings__plugin_state()
{
    ...
    if (! empty($usp->plugin_meta->latest_version) ) {
        if ( version_compare($usp->plugin_meta->version, $usp->plugin_meta->latest_version) === -1 ) {
            ...
            echo '<p class="text-center"><button id="btn-update" form="none" class="btn btn-setup" value="">Update</button><img class="preloader" src="php-usp-master/uniforce/img/preloader.gif"></p>';
